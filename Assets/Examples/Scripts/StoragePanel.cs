...
namespace Examples
{
    public class StoragePanel : MonoBehaviour
    {
        ...
        private IStorage Storage => PlatformDepsBase.Storage;

        private void Start()
        {
            _defaultTypeText.text = $"Default Type: { Storage.defaultType }";
        ...
        private void OnSetStorageDataButtonClicked()
        {
            ...
            Storage.Set(new List<string> { _coinsKey, _levelKey }, new List<object> { coins, level }, _ => _overlay.SetActive(false));
        }
