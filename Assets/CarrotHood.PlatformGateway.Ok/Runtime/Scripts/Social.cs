...
#region InviteFriends
		...
		private static extern void OkShowInvite(string inviteText, Action<int> onSuccess, Action<string> onError);
		...
		public static void InviteFriends(string inviteText, Action<int> onSuccess, Action<string> onError)
		{
			...
			#if !UNITY_EDITOR
			OkShowInvite(inviteText, OnShowInviteSuccess, OnShowInviteError);
			#else
